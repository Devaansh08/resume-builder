          ...
          <div className="space-y-3">
            ...
            {experience.map((exp: Experience) => (
              <div key={exp.id} className="space-y-1 text-xs">
                ...
                {exp.description && <RichText content={exp.description} className="text-[11px] text-surface-700 text-justify" />}
          ...
          <div className="space-y-3">
            ...
            {projects.map((proj: Project) => (
              <div key={proj.id} className="space-y-1 text-xs">
                ...
                {proj.description && <RichText content={proj.description} className="text-[11px] text-surface-700 text-justify" />}
